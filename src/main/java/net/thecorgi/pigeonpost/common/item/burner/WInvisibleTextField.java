...
public class WInvisibleTextField extends WWidget {
    public static final int TEXT_PADDING_X = 1;
    public static final int TEXT_PADDING_Y = 2;
    public static final int CURSOR_PADDING_Y = 2;
    ...
    public WInvisibleTextField() {
    }

    public WInvisibleTextField(Text suggestion) {
    ...
    public WInvisibleTextField setTextPredicate(Predicate<String> predicate_1) {
        this.textPredicate = predicate_1;
        return this;
    }

    public WInvisibleTextField setChangedListener(Consumer<String> listener) {
        this.onChanged = listener;
        return this;
    }

    public WInvisibleTextField setMaxLength(int max) {
        this.maxLength = max;
    ...
    public WInvisibleTextField setEnabledColor(int col) {
        this.enabledColor = col;
        return this;
    }

    public WInvisibleTextField setSuggestionColor(int suggestionColor) {
        this.suggestionColor = suggestionColor;
        return this;
    }

    public WInvisibleTextField setDisabledColor(int col) {
        this.disabledColor = col;
        return this;
    }

    public WInvisibleTextField setEditable(boolean editable) {
    ...
    public WInvisibleTextField setSuggestion(@Nullable String suggestion) {
        this.suggestion = suggestion != null ? new LiteralText(suggestion) : null;
        return this;
    }

    public WInvisibleTextField setSuggestion(@Nullable Text suggestion) {
        this.suggestion = suggestion;
        return this;
    }
